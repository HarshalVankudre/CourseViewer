...
const VideoPlayer = ({
    ...
    return (
        ...
        >
            ...
            {/* Notes Section */}
            <div className="notes-section" style={{ marginTop: '20px', flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                    ...
                    <div style={{
                        ...
                        <SaveStatusIcon status={noteSaveStatus} />
                        <span>
                            {noteSaveStatus === 'saving' && 'Saving...'}
                            {noteSaveStatus === 'saved' && 'Saved'}
                            {noteSaveStatus === 'error' && 'Failed to save'}
                            {noteSaveStatus === 'idle' && 'Auto-save'}
                        </span>
                    </div>
                </div>
                <textarea
                    placeholder="Take notes for this lesson... (Auto-saves as you type)"
                    value={noteContent}
